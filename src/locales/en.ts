...
export type Translations = {
  ...
  hero: { tagline: string; headlineLine1: string[]; headlineLine2: string[]; description: string; exploreSolutions: string; getInTouch: string; trustedBy: string; stats: { value: string; label: string }[]; next: string };
